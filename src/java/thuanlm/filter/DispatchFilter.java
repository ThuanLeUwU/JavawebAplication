...
//                        + "Servlet";
                ...
                if(resource.equals("login")) {
                    ...
                    url = siteMap.getProperty(MyApplicationConstants.LoginFeatures.CART_CONTROLLER);
                } else if(resource.equals("remove")) {
                   url = siteMap.getProperty(MyApplicationConstants.LoginFeatures.REMOVE_BOOK);
                } else if(resource.equals("create")) { 
                   url = siteMap.getProperty(MyApplicationConstants.DispatchFeatures.CREATE_ACCOUNT_CONTROLLER);
                } else if(resource.equals("logoutServlet")) {
                    url = siteMap.getProperty(MyApplicationConstants.LoginFeatures.LOGOUT_CONTROLLER);
                }
            }
            if (url != null) {
